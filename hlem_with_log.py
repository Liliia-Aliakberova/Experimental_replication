...
def transform_log_to_hl_log_width(name, log, frame, traffic_type, selected_f_list, p, connection_thresh, res_info, freq,
    ...
    hl_log_xes, hl_log_df = hl_log.generate_hl_log(name, window_borders_dict, hle_all_by_theta, cascade_dict, tz_info,
